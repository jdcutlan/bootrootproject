...
$sql = 'SELECT pnumber AS "#", pname AS "Player Name", goals AS Goals, ycards AS "Yellow Cards", rcards AS "Red Cards", "" FROM players';
...
<body>
	...
	<table class="data-table">
		<caption class="title">Player Statistics</caption>
		<thead>
			<tr>
			<th>#</th>
			<th>Name</th>

...
$sql = 'SELECT date AS Date, ht.tname AS HomeTeam, hscore AS HomeScore, ascore AS AwayScore, at.tname AS AwayTeam
FROM games g
...
<body>
	...
	<table class="data-table">
		<caption class="title">Mens Football Fixtures & Results</caption>
		<thead>
			<tr>
				<th>Date</th>
				<th>Home Team</th>
